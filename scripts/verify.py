...
Usage:
    ...
    python verify.py deck.html --slides 10                  # Capture the first 10 slides one by one
    python verify.py design.html --output ./screenshots/   # Output directory
    python verify.py design.html --show                    # Open a visible, non-headless browser
...
def main():
    ...
    parser.add_argument("--output", default=None,
                        help="Output directory (default: screenshots/ next to the HTML file)")
    parser.add_argument("--show", action="store_true",
                        help="Run non-headless and open a visible browser window")
